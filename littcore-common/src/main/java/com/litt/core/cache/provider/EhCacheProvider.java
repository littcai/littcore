...
import com.litt.core.cache.ICacheProvider;
...
public class EhCacheProvider implements ICacheProvider {
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICacheProvider#getName()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICacheProvider#buildCache(java.lang.String, boolean, com.litt.core.cache.ICacheExpiredListener)
   */
  @Override
