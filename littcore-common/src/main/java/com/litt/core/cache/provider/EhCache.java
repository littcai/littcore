package com.litt.core.cache.provider;
...
import com.litt.core.cache.CacheException;
import com.litt.core.cache.ICache;
import com.litt.core.cache.ICacheExpiredListener;
...
public class EhCache implements ICache, CacheEventListener {
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#get(java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#put(java.lang.Object, java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#update(java.lang.Object, java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#keys()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#evict(java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#evict(java.util.List)
   */
  @Override
  @SuppressWarnings("rawtypes")
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#clear()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.litt.core.cache.ICache#destroy()
   */
  @Override
