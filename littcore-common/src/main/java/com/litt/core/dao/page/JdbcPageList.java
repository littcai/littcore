...
public class JdbcPageList implements IPageList {
	...
	/* (non-Javadoc)
	 * @see com.litt.core.dao.page.IPageList#setResultsetTransformer(com.litt.core.dao.IResultsetTransformer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.litt.core.dao.page.IPageList#getResultsetTransformer()
	 */
	@Override
