...
import com.littcore.dao.dataset.IDataCell;
...
public abstract class BaseDataCell implements IDataCell {
	...
	/* (non-Javadoc)
	 * @see com.littcore.dao.dataset.cell.IDataCell#getColumnMetadata()
	 */
	...
	/* (non-Javadoc)
	 * @see com.littcore.dao.dataset.cell.IDataCell#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.littcore.dao.dataset.cell.IDataCell#getDataType()
	 */
